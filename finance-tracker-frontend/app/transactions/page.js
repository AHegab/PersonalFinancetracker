    ...
    return (
        <div className="flex justify-center items-center min-h-screen bg-gray-100 p-4 text-black">
                    ...
                    <table className="w-full border-collapse border border-black">
                        <thead>
                            <tr className="bg-gray-200 text-black">
                                ...
                                <th className="border border-black p-2">Vendor</th>
                                <th className="border border-black p-2">Category</th>
                                <th className="border border-black p-2">Payment Method</th>
                        ...
                        <tbody>
                            {transactions.map((transaction) => (
                                <tr key={transaction.id} className="text-center text-black">
            ...
            <Modal
                ...
                className="bg-white rounded-lg p-8 max-w-md mx-auto shadow-lg text-black"
